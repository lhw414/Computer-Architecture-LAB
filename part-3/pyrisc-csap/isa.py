...
# Custom extensions (vector operations) (Match bits)
...
# Custom extensions (vector operations) (Maskbits)
SVUNPACK_MASK    = WORD(0b11111111111100000111000001111111)
SVPACK_MASK      = R_MASK
SVBRDCST_MASK    = WORD(0b11111111111100000111000001111111)
...
isa         = { 
    ...
    SVBRDCST   : [ "sbrdcst",       SVBRDCST_MASK,   R_TYPE,  CL_ALU,   ], 
